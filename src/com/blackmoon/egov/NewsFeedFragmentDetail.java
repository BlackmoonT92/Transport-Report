...
public class NewsFeedFragmentDetail extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//Config.activity.getActionBar().setIcon(R.drawable.newfeeds);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		ImageView imageNews = (ImageView) getView().findViewById(
				R.id.imageAttach);
		final ImageView imageLike = (ImageView) getView().findViewById(R.id.imageLike);
		...
		btnOpenMaps.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				double lon;
				try {
					lat = JSONNews.getDouble(CName.KEY_LATITUDE);

					lon = JSONNews.getDouble(CName.KEY_LONGITUDE);
					if (lat != 0.0) {
